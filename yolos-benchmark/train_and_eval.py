...
def get_data(feature_extractor, loc):

  '''
    Load the datasets in train and validation sets. 
  '''
...
def load_data(train_dataset, val_dataset):
  '''
    The torch DataLoader class makes the dataset iterable. 
  '''
...
def evaluate_data(model, device, val_dataloader):
...
train_dataset, val_dataset = get_data(feature_extractor, loc)

train_dataloader, val_dataloader = load_data(train_dataset, val_dataset)
